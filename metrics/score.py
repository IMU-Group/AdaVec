...
if __name__ == '__main__':
    mse_1 = calc_ssim(img1_path="/root/autodl-tmp/img2vec/metrics/groundtruth/noto-emoji/emoji_u1fab0.png", img2_path="/root/autodl-tmp/img2vec/metrics/results/ours/noto-emoji/emoji_u1fab0.png")
    print(mse_1)
    # mse_2 = calc_mse_2(img1_path="/root/autodl-tmp/img2vec/metrics/groundtruth/noto-emoji/emoji_u1fab0.png",
    #                    img2_path="/root/autodl-tmp/img2vec/metrics/results/ours/noto-emoji/emoji_u1fab0.png")
    # print(mse_2)
